...
entries for at most a week (~75 KB at that cap); it never leaves the
device; and the "Clear cached articles" action in Settings empties it along
with the article store.
